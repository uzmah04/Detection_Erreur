...
# Si le array a un nombre pair de "1", le programme va ajouter "1" devant la suite binaire			
if a%2==0:
	binaire = "1" + binaire
# Si le array a un nombre impair de "1", le programme va ajouter "0" devant la suite binaire
else:
	binaire = "0" + binaire

print("Bit de parite impair : ", binaire)
